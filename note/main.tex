...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{vs-biasmut-woprior.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{vs-biasmut-lucyprior.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{vs-biasmut-profileprior.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{vs-biasmut-wopriorwospace.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{vs-biasmut-lucypriorwospace.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{vs-biasmut-profilepriorwospace.png}
\end{figure}
