...
gsd = gridspec.GridSpec(len(Sigma), len(Tau), figure=figd, left=0.1, right=0.8, top=0.95, bottom=0.1, wspace=0.3, hspace=0.35)
figdd = plt.figure(figsize=(len(Tau) * 6, len(Sigma) * 5))
gsdd = gridspec.GridSpec(len(Sigma), len(Tau), figure=figd, left=0.1, right=0.8, top=0.95, bottom=0.1, wspace=0.3, hspace=0.35)
figw = plt.figure(figsize=(len(Tau) * 6, len(Sigma) * 5))
gsw = gridspec.GridSpec(len(Sigma), len(Tau), figure=figw, left=0.1, right=0.8, top=0.95, bottom=0.1, wspace=0.3, hspace=0.35)
figr = plt.figure(figsize=(len(Tau) * 6, len(Sigma) * 5))
gsr = gridspec.GridSpec(len(Sigma), len(Tau), figure=figr, left=0.1, right=0.8, top=0.95, bottom=0.1, wspace=0.3, hspace=0.35)
alpha = 0.05
...
gs = gridspec.GridSpec(1, 2, figure=fig, left=0.1, right=0.9, top=0.95, bottom=0.1, wspace=0.3, hspace=0.35)
