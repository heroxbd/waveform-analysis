...
\begin{figure}[H]
  ...
  \begin{subfigure}{.5\textwidth}
    ...
    \caption{\label{fig:fitting}$\Delta{t_0}=\SI{-3.22}{ns}$, $\mathrm{RSS}=\SI{7.63}{mV^2}$,$D_w=\SI{0.68}{ns}$}
  \end{subfigure}
...
In figure~\ref{fig:method}, sparsity of $q'_i$ is evident as speculated.  However, the majority of the results $\hat{q}_i$ is less than 1.  That motivates us to incorporate prior knowledge of $q'_i$ towards a more dedicated and performant model.
