...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
where $\mathcal{P}$ is for Poisson distribution.  Unlike eq.~\eqref{eq:mixnormal}, $z_i$ can take non-negative integers larger than 1, meaning the number of PE's in the $i$-th time bin.  Marginalizing out $\bm{z}$,
\begin{equation}
  \begin{aligned}
...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
We calculate RSS and $D_w$ by eqs.~\eqref{eq:rss}, \eqref{eq:mcmc-w}, \eqref{eq:numerical} and \eqref{eq:gd-phi}.
