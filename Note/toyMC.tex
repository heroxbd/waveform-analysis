...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{A single PE from a PMT induces a voltage pulse in \subref{fig:spe}.  Multiple PEs piling up at a PMT form a waveform in \subref{fig:pile}, when PEs are barely visually separable from each other.}
\end{figure}
