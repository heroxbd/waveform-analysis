...
Considering the existing bias of $\mu$, the charge resolution is defined as the standrad deviation of $\log{\hat{\mu}}$. Figure~\ref{fig:deltamu} shows the charge resolution of both integration and FBMP. When $\mu$ is small, FBMP shows convincing resolution as expected. 
