...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{The dependence of $D_\mathrm{w}$~\subref{fig:wdistsummary} and RSS~\subref{fig:rsssummary} on light intensity $\mu$ for typical Cherenkov (left) and scintillation (right) configurations.  The error bars are 5--95 percentile.}
\end{figure}
