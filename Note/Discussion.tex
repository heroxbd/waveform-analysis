...
The $D_\mathrm{w}$ dependence on $\mu$ of four remaining methods, LucyDDM, Fitting, CNN and FBMP, is plotted in figure~\ref{fig:wdistsummary}.  We see they approaching each other when $\mu$ increases.
...
\begin{figure}[H]
  \begin{subfigure}[b]{\textwidth}
    ...
    \caption{\label{fig:wdistsummary} $D_\mathrm{w}$}
  \end{subfigure}
  \begin{subfigure}[b]{\textwidth}
