...
\begin{figure}[H]
  \begin{subfigure}[b]{\textwidth}
    \centering
    \resizebox{0.99\textwidth}{!}{\input{figures/vs-bias.pgf}}
    \vspace{-0.5em}
  ...
  \begin{subfigure}[b]{\textwidth}
    \centering
    \resizebox{0.99\textwidth}{!}{\input{figures/vs-deltamethodsdiv.pgf}}
    \vspace{-0.5em}
  ...
  \begin{subfigure}[b]{\textwidth}
    \centering
    \resizebox{0.99\textwidth}{!}{\input{figures/vs-biasmu.pgf}}
    \vspace{-0.5em}
  ...
  \begin{subfigure}[b]{\textwidth}
    \centering
    \resizebox{0.99\textwidth}{!}{\input{figures/vs-deltamethodsdivmu.pgf}}
    \vspace{-0.5em}
