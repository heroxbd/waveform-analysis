...
\begin{figure}[H]
    ...
    \caption{\label{fig:chargesummary} $D_\mathrm{w}$ for all the methods with the same dataset as figure~\ref{fig:method}. The error bars are 5 to 95 percentiles. Time consumption of CNN is in two conditions: CPU\tablefootnote{100 CPU cores of AMD EYPC\texttrademark\ 7742} and GPU\tablefootnote{one graphics card of NVIDIA\textsuperscript{\textregistered} A100.}. }
\end{figure}
