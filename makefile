...
$$(firstword $$(analysis_$(1))) : $$(firstwordr $$(raw_$(1)))
	mkdir -p $$(dir $$@)
	time python3 -u Prediction_Processing_Total.py $$(dir $$<) /mnt/eternity/baseline/run$(1) $(shell ./get_gaintable.py $(1)) -N old1029/ --met charge --device 0 -o $$(dir $$@) -B 17000 > $$(dir $$@)/analysis.log 2>&1
