...
We have reformed the tonality around the text of Fig. 3 to emphasize the resolution losses by the 1st-PE estimator.  Except for only 2 special cases (exponential light curve or 0-1 count region), the improvement is far more significant (x2 difference) in most of the experimental setups.
